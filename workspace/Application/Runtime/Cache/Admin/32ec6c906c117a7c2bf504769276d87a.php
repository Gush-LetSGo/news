...
<div class="s_center container">
    ...
    <form class="form-signin col-md-6" enctype="multipart/form-data"  method="post">
      ...
      <br />
      <button class="btn btn-lg btn-primary btn-block" type="button" onclick="login.checkUser()">登录</button>
    </form>
	<div class="col-md-3"></div>
</div> <!-- /container -->
